...
3) Se dice que las [[Variable aleatoria continua]] $X_1, \cdots, X_n$ son independientes si la [[Función de densidad para vector aleatorio]] es igual al producto de las [[Función de densidad marginal]] para cada [[Variable aleatoria continua]]. $$  f_{X_1, \dots, X_n}(x_1, \cdots, x_n) = f_{x_1}(x_1) \cdot ... \cdot f_{X_n}(x_n) = \prod_{i \in [1, n]} f_{X_i}(x_i)  $$
